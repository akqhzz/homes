...
import { AreaSparkline, HBarChart, PieChart, DonutGauge } from '@/components/ui/charts';
import { cn } from '@/lib/utils/cn';

/* ══════════════════════════════════════════════════════════════════
   PAGE-LOCAL SVG CHART PRIMITIVES
   (shared ones — AreaSparkline, HBarChart, PieChart, DonutGauge —
   live in @/components/ui/charts)
══════════════════════════════════════════════════════════════════ */
