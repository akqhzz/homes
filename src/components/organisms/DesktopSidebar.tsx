...
export default function DesktopSidebar() {
  ...
  return (
    <aside className="hidden h-full w-[84px] shrink-0 border-r border-[#F1F3F5] bg-white lg:flex lg:flex-col lg:items-center lg:justify-between lg:py-5">
      <button
        type="button"
        onClick={() => router.push('/')}
        className="flex h-11 w-11 items-center justify-center text-[2.1rem] font-heading font-semibold leading-none tracking-[-0.06em] text-[#0F1729]"
        aria-label="Homes"
      >
        h.
      </button>
